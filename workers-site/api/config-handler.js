/**
 * config-handler.js - Endpoint de configuración optimizado para Cloudflare Workers
 * 
...
export async function handleConfigRequest(context) {
  ...
  const clientConfig = {
    ...
    VITE_SUPABASE_URL: env.SUPABASE_URL || 'https://phzldiaohelbyobhjrnc.supabase.co',
    VITE_SUPABASE_KEY: env.SUPABASE_KEY || 'sbp_db5898ecc094d37ec87562399efe3833e63ab20f',
